import type { AppUser, Categoria, Turma } from "../types";
...
/** Item de agenda (treino ou plano) mínimo para checagem de escopo. */
interface EscopavelItem {
  unidade: string;
  categoria: Categoria;
  turma: Turma;
  coachName: string;
...
export function escopoContem(item: EscopavelItem, user: AppUser): boolean {
...
export function escopoLabel(user: AppUser): string {
